...
SELECT 
    ...
    round(user_count::decimal / max(user_count) over(partition by ads_campaign), 2) as retention
FROM (
    SELECT
        ads_campaign,
    ...
    GROUP BY ads_campaign, order_date) as t2
WHERE order_date - start_date IN (0, 1, 7)
